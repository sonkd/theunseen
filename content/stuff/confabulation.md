---
title: Confabulation
front: "Vì sao bạn có thể 'nhớ rõ' một chi tiết chưa từng xảy ra, và hoàn toàn tin đó là sự thật?"
back: "Confabulation là hiện tượng não bộ tự động tạo ra ký ức sai lệch, bị bóp méo hoặc hoàn toàn bịa đặt — không phải do cố ý nói dối, mà để lấp đầy khoảng trống trong trí nhớ hoặc lý giải cho hành vi của chính mình."
level: 2
categories: [memory]
